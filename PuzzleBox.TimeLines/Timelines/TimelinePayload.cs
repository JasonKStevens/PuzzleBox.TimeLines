...
{
  public class TimelinePayload<T> : ITimeline where T: TimePayload
  {
    ...
    public TimelinePayload(LocalDateTime? start = null, LocalDateTime? end = null, TimePayload payload = null, DateTimeZone timezone = null) : this(new OverlappingIntervals<T>(new LocalInterval(start, end).AddPayload(payload)), timezone)
    {
    }
