...
{
  public class MaskNotIntersectionTests
  {
    [Test]
    ...
    public void Intersect_Inside()
    {
      ...
      {
        new LocalInterval(new LocalDateTime(2008, 1, 4, 0, 0), new LocalDateTime(2008, 1, 5, 0, 0)),
        new LocalInterval(new LocalDateTime(2008, 1, 6, 0, 0), new LocalDateTime(2008, 1, 8, 0, 0)),
      }).GetIntervals();
